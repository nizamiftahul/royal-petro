...
import { ListenerType } from './interfaces.mjs';
import { eventShouldStartDrag, eventShouldEndDrag, isTouchEvent } from './utils/predicates.mjs';
import { getEventClientOffset, getNodeClientOffset } from './utils/offsets.mjs';
import { distance, inAngleRanges } from './utils/math.mjs';
import { supportsPassive } from './utils/supportsPassive.mjs';
...
//# sourceMappingURL=TouchBackendImpl.mjs.map